...
export function fillMovieMetadata(movie, metadata) {
  const result = { ...movie };
  for (const key of ["originalTitle", "englishTitle", "releaseYear", "durationMinutes", "directors", "actors", "cast", "productionCountries", "tmdbId", "posterUrl", "backdropUrl", "trailerUrl"]) {
